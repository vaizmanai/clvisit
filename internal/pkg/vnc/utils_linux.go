	...
	arrayVNC = []VNC{
		{
			...
			CmdStartServer:       "x11vnc -auth guess -forever -loop -noxdamage -repeat -noipv6 -localhost -rfbport 32801 -rfbportv6 0 -shared -display :0",
			...
			CmdStartServerUser:   "x11vnc -auth guess -forever -loop -noxdamage -repeat -noipv6 -localhost -rfbport 32801 -rfbportv6 0 -shared -display :0",
